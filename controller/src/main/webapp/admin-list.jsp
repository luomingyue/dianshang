			...
			<div class="layui-col-md12">
				<div class="layui-card">
					...
					<div class="layui-card-header">
						...
						<a href="add_admin.jsp"><button class="layui-btn">
                              ...
                              %> --%>
								<c:forEach items="${admins}" var="admin">
									<tr>
										...
										</a> <a title="编辑" href="load.admin?id=${admin.id}"> <i
												class="layui-icon">&#xe642;</i>
										</a> <a id="delete" title="删除" href="javascript:;"> <i
												onclick="del(${admin.id})" class="layui-icon">&#xe640;</i>
										</a></td>
